...
.publish { background:#23863633; color:#3fb950; }
.draft   { background:#d2992233; color:#e3b341; }
.pending { background:#da363333; color:#ff7b72; }

/* ===== TAMBAHAN SAJA (tidak mengubah yg lama) ===== */
#stars{
    position:absolute;
    top:0;
    left:0;
...
<div class="header-bar">
    <div class="page-title">
        <h4 class="fw-semibold">Data Artikel</h4>
        <small class="text-muted">Manajemen artikel blog</small>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table id="artikelTable" class="table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Judul</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge-status 
                                <?= $row['status']=='publish' ? 'publish' : ($row['status']=='draft' ? 'draft' : 'pending') ?>">
                                <?= $row['status']; ?>
                            </span>
                        </td>
                        <td><?= $row['views']; ?></td>
                        ...
                        <td>
                            ...
                            <a href="hapus.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"
                               onclick="return confirm('Yakin hapus artikel?')">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
