...
/* ===== TAMBAHAN ANIMASI (TIDAK MENGUBAH YANG LAIN) ===== */
#stars{
    position:absolute;
    top:0;
    left:0;
...
<div class="main-content">
    ...
    <div class="header-bar">
        <div class="page-title">
            <h4 class="fw-semibold">Data Kategori</h4>
            <small class="text-muted">Manajemen kategori blog</small>
        </div>
    </div>
