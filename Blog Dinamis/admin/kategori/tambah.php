...
<div class="header-bar">
    <div class="page-title">
        <h4 class="fw-semibold">Tambah Kategori</h4>
        <small style="color:#8b949e;">Buat kategori baru</small>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="simpan.php" method="POST">
            <div class="mb-4">
                ...
                <input type="text" name="nama_kategori" class="form-control" placeholder="Contoh: Teknologi, Lifestyle..." required>
            </div>
