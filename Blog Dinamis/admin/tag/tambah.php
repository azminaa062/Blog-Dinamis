...
<div class="header-bar">
    <div class="page-title">
        <h4 class="fw-semibold">Tambah Tag</h4>
        <small style="color:#8b949e;">Buat tag baru</small>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="simpan.php" method="POST">
            <div class="mb-4">
                ...
                <input type="text" name="nama_tag" class="form-control" placeholder="Contoh: PHP, Laravel, JavaScript..." required>
            </div>
