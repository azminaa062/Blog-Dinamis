...
<div class="main-content">
    ...
    <div class="header-bar">
        <div class="page-title">
            <h4 class="fw-semibold">Data Tag</h4>
            <small class="text-muted">Manajemen tag blog</small>
        </div>
    </div>

    <a href="tambah.php" class="btn btn-primary mb-3">+ Tambah Tag</a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"
                                   onclick="return confirm('Yakin hapus tag?')">Hapus</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
...
<!-- STAR ANIMATION (3D DASHBOARD STYLE) -->
<script>
