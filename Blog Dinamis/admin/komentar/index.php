...
<div class="main-content">
    ...
    <!-- CANVAS BINTANG -->
    <canvas id="stars" style="position:absolute;top:0;left:0;width:100%;height:100%;z-index:0;pointer-events:none;"></canvas>

    <div class="header-bar">
        <div class="page-title">
            <h4 class="fw-semibold">Data Komentar</h4>
            <small class="text-muted">Manajemen komentar blog</small>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"
                                   onclick="return confirm('Yakin hapus komentar?')">Hapus</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
